...
def mudarDiretorios():
    if (FLAGS.pc == "0"):#pessoa
        dirImgEntrada = "H:\\SmithHD\\Documentos\\4-github\\AppArtigo\\python\\4imagensSaida"
        dirPlotHistEntrada = "H:\\SmithHD\\Documentos\\4-github\\AppArtigo\\python\\5histoImagensSaida\\"
        dirClassificacaoEntrada = "H:\\SmithHD\\Documentos\\4-github\\AppArtigo\\python\\7ClassificacaoImagem\\"

    elif (FLAGS.pc == "1"):#projeto
        dirImgEntrada = "C:\\Users\\Smith Fernandes\\Documents\\4 - github\\AppArtigo\\python\\4imagensSaida"
        dirPlotHistEntrada = "C:\\Users\\Smith Fernandes\\Documents\\4 - github\\AppArtigo\\python\\5histoImagensSaida\\"
